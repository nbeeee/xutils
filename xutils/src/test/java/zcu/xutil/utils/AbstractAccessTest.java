...
public class AbstractAccessTest {
	public static @Inject("f1") String field1;
	public static String field2;

	public @Inject("f3") String field3;
	public String field4;
	public  static class B extends AbstractAccessTest{
		public static @Inject("f5") String field5;
		public static String field6;

		public @Inject("f7") String field7;
...
//		AbstractAccess access = new AccessProperty(32,new Checker<Accessor>(){
//			public boolean checks(Accessor accessor) {
