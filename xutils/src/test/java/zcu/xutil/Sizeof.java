...
public class Sizeof {
	...
	static void testCaller(){
		ObjutilTest.equalsIgnoreCase("","");
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String name="method";
		Class<?> c =Sizeof.class;
		Method m =c.getMethod(name, params);
		Field fld =c.getField("field");
		...
		for (int i = -1; i < count; ++i) {
			...
			//object = c.getField("field");
			//object =c.getConstructor(Objutil.emptyTypes);
			object  = Pattern.compile("(?-i)true|falseeeeeeeerrrrrrrrr");
			//object=c.getMethod(name, params);
	...
	public Object getWqqqq(){
		return null;
	}
	public Object getrrrrqqqq(){
		return null;
	}
